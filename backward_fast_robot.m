...
% Motor torque
tau_ = ms*(kspring*(th2-th1-ang) + taumag*(cos(2*pi*freq*t)) - dspring*(w1-w2));
...
hold all
for n = 1
    stem((n-1)/(2*1)+(1:8),100*[ac{n},ae{n},fc{n},fe{n},rc{n},re{n},bc{n},be{n}]/ ...
...
KEee=KEs{1}(:,1)+KEs{1}(:,2);
PEee=PEs{1}(:,1)+PEs{1}(:,2);
